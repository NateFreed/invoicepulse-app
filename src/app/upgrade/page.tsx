...
export default function UpgradePage() {
  ...
  async function handleSubscribe() {
    ...
    try {
      ...
      const { data, error } = await supabase.functions.invoke('create-subscription-checkout', { body: { plan_id: 'invoicepulse_pro', user_email: user.email } });
  ...
  return (
    <div className="max-w-lg mx-auto py-12 px-4 text-center">
      <h1 className="text-3xl font-bold mb-2">Upgrade to InvoicePulse Pro</h1>
      <p className="text-muted mb-6">Unlimited invoices, AI line items, recurring billing</p>
      <div className="glow-card p-6 mb-6">
        <div className="mb-4"><span className="text-4xl font-bold">$12</span><span className="text-muted">/mo</span></div>
        <ul className="space-y-2 mb-6 text-left text-sm text-muted">
          <li>Unlimited invoices</li>
          <li>AI-powered line item suggestions</li>
          <li>Recurring billing automation</li>
          <li>Payment links via Stripe</li>
