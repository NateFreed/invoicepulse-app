  ...
  return (
    <main className="flex-1 flex items-center justify-center px-4 relative overflow-hidden">
      ...
      <div className="text-center relative z-10">
        ...
        <p className="text-muted mb-8">Sign in to manage your invoices</p>
        <AuthForm mode="login" />
        <p className="mt-6 text-sm text-muted">
          Don&apos;t have an account?{' '}
          <Link href="/auth/signup" className="text-accent-light hover:text-accent font-medium">Sign up</Link>
        </p>
      </div>
    </main>
  );
